class SwiftXcodeServerApi < Formula
  ...
  url "https://github.com/SwiftXcode/SwiftServerAPI_XcodeImage/archive/0.1.0.tar.gz"
  # curl -L https://github.com/SwiftXcode/SwiftServerAPI_XcodeImage/archive/0.1.0.tar.gz | shasum -a 256
